...
# ==============================================================================
# TAB 1: 블루베리 팬케이크 시뮬레이션 (수정됨: 6개/20개 세트 고정)
# ==============================================================================
with tab1:
    ...
    **알고리즘:**
    ...
    with col1:
        st.subheader("⚙️ 설정")
        # 블루베리 개수 슬라이더 삭제 (20개 고정)
        pancake_trials = st.number_input("몇 세트 구울까요? (N)", min_value=10, max_value=10000, value=100, step=10, key="p_trials")
...
with tab2:
    ...
    * 최댓값이 **5, 6** 👉 Player B 승리
    ...
    with col1:
        st.subheader("⚙️ 설정")
        banana_trials = st.number_input("게임 횟수 (N)", min_value=10, max_value=10000, value=100, step=10, key="b_trials")
